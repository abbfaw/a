odoo.define('pos_load_offline.models', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        load_server_data: async function () {
            ...
            if (!(await this._allowCaching())) {
                ...
                if (await IndexedDB.get('pos_session_id') !== odoo.pos_session_id) {
                    await this._invalidateCaches();
                    await IndexedDB.set('pos_session_id', odoo.pos_session_id);
                }
            }
            await IndexedDB.set('stopCaching', false);
        ...
        after_load_server_data: async function(){
            return _super_PosModel.after_load_server_data.apply(this, arguments).then(function () {
                IndexedDB.set('stopCaching', true)
            })
        },
