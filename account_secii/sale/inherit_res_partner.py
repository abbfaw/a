...
class InheritResPartner(models.Model):
    ...
    commune = fields.Selection([('abobo', "Abobo"),
                               ...
                               string="Communes")
    montant_total_facture = fields.Monetary(string="Montant Total factures")
    montant_total_encaissement = fields.Monetary(string="Montant Total encaissements")
    ...
    def rst_a_payer(self):
        ...
        for so in self:
            ...
            so.reste_payer = so.montant_total_facture - so.montant_total_encaissement
