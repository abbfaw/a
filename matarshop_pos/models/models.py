...
class InheritPosSession(models.Model):
    ...
    amount_expected = fields.Monetary(string='Montant Attendu', compute='_compute_amount_expected')
    cash_number = fields.Integer(string='Entree/Sortie', compute='_compute_amount_expected')
    cash_in_out = fields.Monetary(string='Total cash in/out ', compute='_compute_amount_expected')
    amount_orders_total = fields.Monetary(string='Montant commande', compute='_compute_amount_expected')
    amount_bank = fields.Monetary(string='commandes banques', compute='_compute_amount_expected')
    amount_cash = fields.Monetary(string='commandes espèces', compute='_compute_amount_expected')
